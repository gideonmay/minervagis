...
SET(VR_JUGGLER_INCLUDES ${VRJ_INC_DIR} ${VPR_INC_DIR} ${GADGET_INC_DIR} ${SONIX_INC_DIR} ${JCCL_INC_DIR} )
...
FIND_LIBRARY(VRJ_LIBRARY_RELEASE vrj-3_0_0 vrj-2_2 
...
FIND_LIBRARY(VRJ_OGL_LIBRARY_RELEASE vrj_ogl-3_0_0  vrj_ogl-2_2 
  "$ENV{VJ_BASE_DIR}/lib64"
  "$ENV{VJ_BASE_DIR}/lib"
  /usr/local/lib64
  /usr/local/lib
...
FIND_LIBRARY(SONIX_LIB sonix-1_4_0 sonix-1_2 
  "$ENV{VJ_BASE_DIR}/lib64"
  "$ENV{VJ_BASE_DIR}/lib"
  /usr/local/lib64
  /usr/local/lib
...
FIND_LIBRARY(VPR_LIBRARY_RELEASE vpr-2_2_0 vpr-2_0 
  "$ENV{VJ_BASE_DIR}/lib64"
  "$ENV{VJ_BASE_DIR}/lib"
  /usr/local/lib64
  /usr/local/lib
...
FIND_LIBRARY(GADGET_LIBRARY_RELEASE gadget-2_0_0 gadget-1_2 
  "$ENV{VJ_BASE_DIR}/lib64"
  "$ENV{VJ_BASE_DIR}/lib"
  /usr/local/lib64
  /usr/local/lib
...
FIND_LIBRARY(JCCL_LIB jccl-1_4_0 jccl 
  "$ENV{VJ_BASE_DIR}/lib64"
  "$ENV{VJ_BASE_DIR}/lib"
  /usr/local/lib64
  /usr/local/lib

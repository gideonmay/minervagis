...
Minerva::Layers::GDAL::ConnectionInfo* ConnectToDatabase::exec()
{
  Minerva::Layers::GDAL::ConnectionInfo::RefPtr connection ( 0x0 );

  this->_restoreConnections();

  if ( QDialog::Accepted == BaseClass::exec() )
  {
    connection = new Minerva::Layers::GDAL::ConnectionInfo;

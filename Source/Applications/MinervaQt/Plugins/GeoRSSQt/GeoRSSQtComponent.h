...
#include "MinervaQt/Plugins/GeoRSSQt/CompileGuard.h"
...
protected:
  ...
  virtual void                apply ( Minerva::Core::Data::Feature *feature, DataLoadedCallback dataLoadedCallback );

  /// ILayerModifyQtGUI
  virtual bool handle ( Minerva::Core::Data::Feature *feature ) const;

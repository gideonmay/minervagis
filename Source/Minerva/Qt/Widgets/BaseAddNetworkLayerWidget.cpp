...
BaseAddNetworkLayerWidget::BaseAddNetworkLayerWidget ( const Options& options, QWidget *parent ) : BaseClass ( parent ),
  _imageTypes ( 0x0 ),
...
{
  QString text ( _baseAddNetworkLayerWidget->_server->text() );
  const std::string server ( boost::algorithm::trim_copy ( text.toStdString() ) );
  return server;
}
...
bool BaseAddNetworkLayerWidget::isTransparent() const
{
  return Qt::Checked == _baseAddNetworkLayerWidget->transparentCheckBox->checkState();
}


///////////////////////////////////////////////////////////////////////////////
//
//  Set the options button visibility
//
///////////////////////////////////////////////////////////////////////////////

void BaseAddNetworkLayerWidget::setViewOptionsVisibility ( bool value )
{
  _baseAddNetworkLayerWidget->viewOptionsButton->setVisible ( value );
}

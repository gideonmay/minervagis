...
public:
  ...
  BaseAddNetworkLayerWidget ( const Options&, QWidget *parent = 0x0 );
  virtual ~BaseAddNetworkLayerWidget();

  virtual void apply ( Minerva::Core::Data::Feature* parent ) = 0;
  ...
  void setViewOptionsVisibility ( bool value );

...
namespace Helper
{
  inline Minerva::QtWidgets::TreeNode* nodeFromIndex ( const QModelIndex& index )
  {
...
void TreeControl::buildTree ( Minerva::Core::Data::Feature *feature )
{
  this->setRootNode ( new TreeNode ( feature ) );
}

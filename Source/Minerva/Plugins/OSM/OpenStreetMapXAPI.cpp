...
#include "Minerva/Plugins/OSM/OpenStreetMapXAPI.h"
...
OpenStreetMapXAPI::OpenStreetMapXAPI() : BaseClass(),
  _cache ( 0x0 ),
  _url ( "http://xapi.openstreetmap.org" ), // Default url.
  _requestMap(),
  _styleMap()
{
...
OpenStreetMapXAPI::TileVectorJobs OpenStreetMapXAPI::launchVectorJobs (
  double minLon, 
  double minLat, 
  double maxLon, 
  double maxLat, 

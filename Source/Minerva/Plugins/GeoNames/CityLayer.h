...
#include "Minerva/Plugins/GeoNames/Export.h"
#include "Minerva/Plugins/GeoNames/City.h"
...
public:
  ...
  USUL_DECLARE_REF_POINTERS ( CityLayer );
  
  CityLayer();
  
  virtual Minerva::Core::Data::Feature* clone() const { return new CityLayer ( *this ); }
  ...
  // Update.
  virtual void                updateNotify ( Minerva::Core::Data::CameraState* camera, Minerva::Common::IPlanetCoordinates *planet, Minerva::Common::IElevationDatabase *elevation );

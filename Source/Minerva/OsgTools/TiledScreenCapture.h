...
class MINERVA_OSG_TOOLS_EXPORT TiledScreenCapture
{
public:
  ...
  // Create the image.
  void                         operator () ( osg::Image& image, osg::Node* scene, const osg::Matrix& projection );
  osg::Image*                  operator () ( osg::Node* scene, const osg::Matrix& projection );

...
struct IWithinExtents : public Usul::Interfaces::IUnknown
{
  ...
  virtual Minerva::Core::Data::Feature::RefPtr    getItemsWithinExtents ( double minLon, double minLat, double maxLon, double maxLat, Usul::Interfaces::IUnknown::RefPtr caller = Usul::Interfaces::IUnknown::RefPtr ( 0x0 ) ) const = 0;
};

...
void FindMinMaxDates::visit ( Minerva::Core::Data::Container &object )
{
  FindMinMaxDates::visit ( (Minerva::Core::Data::Feature& ) object );
...
{
  if ( Date ( boost::date_time::not_a_date_time ) == date )
    return;

...
void _registerTypes()
{
  ...
  Usul::Factory::ObjectFactory::instance().add ( new Usul::Factory::TypeCreator<ClassA,Usul::Base::Referenced> ( "ClassA" ) );
  Usul::Factory::ObjectFactory::instance().add ( new Usul::Factory::TypeCreator<ClassB,Usul::Base::Referenced> ( "ClassB" ) );
  Usul::Factory::ObjectFactory::instance().add ( new Usul::Factory::TypeCreator<ClassC,Usul::Base::Referenced> ( "ClassC" ) );
  Usul::Factory::ObjectFactory::instance().add ( new Usul::Factory::TypeCreator<ClassD,Usul::Base::Referenced> ( "ClassD" ) );
  Usul::Factory::ObjectFactory::instance().add ( new Usul::Factory::TypeCreator<ClassE,Usul::Base::Referenced> ( "ClassE" ) );
  Usul::Factory::ObjectFactory::instance().add ( new Usul::Factory::TypeCreator<ClassF,Usul::Base::Referenced> ( "ClassF" ) );
  Usul::Factory::ObjectFactory::instance().add ( new Usul::Factory::TypeCreator<ClassG,Usul::Base::Referenced> ( "ClassG" ) );
}

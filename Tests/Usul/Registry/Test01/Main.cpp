...
void _runTest()
{
...

  {
    ...
    // Write it to disk.
    XmlTree::RegistryIO::write ( a, Usul::Registry::Database::instance() );
  }

  {
    ...
    // Read it from disk.
    XmlTree::RegistryIO::read ( a, Usul::Registry::Database::instance() );

    // Write it to disk.
    XmlTree::RegistryIO::write ( b, Usul::Registry::Database::instance() );

    // Write it to disk.
    XmlTree::RegistryIO::read ( b, Usul::Registry::Database::instance() );
  }
